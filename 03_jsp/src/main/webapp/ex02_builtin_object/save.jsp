...
<%
  ...
  // 저장할 디렉터리 경로
  // RealPath 경로 : D:\GDJ69\jspstudy\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\02_jsp
  ...
  // 파일 생성 여부를 확인하는 xx.jsp로 이동 (주소 뒤에 dir과 filename값을 보내줘서 result.jsp에서 확인한다.)
