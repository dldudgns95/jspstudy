...
public class Binding1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   * 4. 저장 영역 (HttpSession와 HttpServletRequest를 많이 사용함)
	   *   1) ServletContext     : 컨텍스트(프로젝트, 애플리케이션) 종료 전까지 값을 저장할 수 있다.
	   *                           애플리케이션이 실행중이라면 어디서든 값에 접근할 수 있다.
	   *   2) HttpSession        : 세션 종료 전까지 값을 저장할 수 있다.
	   *                           웹 브라우저가 실행중이라면 어디서든 값에 접근할 수 있다.(시간 지정 가능)
	   *   3) HttpServletRequest : 요청 종료 전까지 값을 저장할 수 있다.
	   *                           응답 전이라면 값에 접근할 수 있다.(1회용 정보)
	  ...
	  System.out.println("  Binding1 체크  ");
